...
const introdata = {
    ...
    img_url: "https://i.postimg.cc/Twm00rfW/pngkey-com-dr-strange-png-5591712.png",
};

const dataabout = {
    title: "abit about my self",
    aboutme: "he/him. 22 years old (june 27). can speak 6 languages. honour/dean's list 2 times. quick learner. problem solver. hackathon enjoyer. congenial & committed. scared of dogs & heights. ice breaker. kpop, kdramas, & anime.",
};
const worktimeline = [{
...
const services = [{
        title: "Asahi’sDen",
        description: "Again, needs to be eidted. will add github links at the end of each.\n · Programmed eCommerce web application following MVC design pattern leveraging Handlebars template engine and Express framework\n· Built a responsive design using Bootstrap4 and connected to a database with MongoDB",
    },
    {
        title: "Vroom-Rent",
        description: "· Currently developing a WebApp following Agile SDLC for a client that helps user search and rent apartments available with ease\n · User are able to securely Signup/Login and book an appointment with the landlord/s\n· Implemented Google Maps API to the app, to pin point the exact location of the apartment",
    },
    {
        title: "nlinks",
        description: "· Designed and coded an Open-Sourced Node CLI that find’s the status of websites\n· Made use of different types of packages from NPM and API’s to automate the CLI\n· The CLI can load data from any type of files and overwrite if wanted",
    },{
        title: "COVID-Tracker",
        description: "· Created a COVID-19 Tracker App using React, ChartsJS, and MaterialUI for the UI Design\n· Data is fetched from the COVID-19 API using Async/Await syntax and React Hooks, and statistics are displayed in cards as well as in charts",
    },
];
...
const contactConfig = {
    YOUR_EMAIL: "theniaz619@gmail.com",
    YOUR_FONE: "+1 (647) 657 6450",
    description: "interested in me? shoot me a quick email or contact me via phone or any of my socials, will reply asap.",
...
const socialprofils = {
    github: "https://github.com/Niaz-Ul-Haque",
    facebook: "https://www.facebook.com/profile.php?id=100004669278611",
    linkedin: "https://www.linkedin.com/in/mohammed-niaz-ul/",
    twitter: "https://twitter.com/AsahiKibo1",
};
export {
    meta,
    dataabout,
